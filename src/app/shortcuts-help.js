...
const GROUPS = [
  ...
  },
  {
    ...
    rows: [
      ["Ctrl+Shift+F", "фокус-режим — спрятать шапку/боковую панель, пока открыта карточка"],
      ["📌 в карточке", "открепить отчёт в отдельном маленьком окне поверх остальных программ"],
    ],
  },
  {
